          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
              <div className="md:col-span-12 lg:col-span-5 xl:col-span-4 ">
                ...
                <Image src={secondfold} alt="new" className="w-[80%] mx-auto
                   object-contain" />
              </div>
                ...
                <TooltipProvider>
                  {
                    [
                      ...
                      <Tooltip key={i}>
                        <TooltipTrigger> <Image src={image} alt="avc" className={`rounded-full bg-orange-300 w-[80px] h-[80px] hover:scale-95  hover:border-2 hover:border-black transition-all duration-700`} /></TooltipTrigger>
                ...
                <TooltipProvider>
                  {
                    [
                      ...
                      <Tooltip key={name} delayDuration={500}>
                        <TooltipTrigger> <Image src={image} alt="Book Writing Experts" className={`rounded-full bg-orange-300 w-[80px] h-[80px] hover:scale-95  hover:border-2 hover:border-black transition-all duration-700`} /></TooltipTrigger>
                        <TooltipContent className="bg-white">
                          <div className="p-7 border-2 rounded-[10px] text-left  flex justify-around flex-col before:content-[''] hover:before:h-[100%] hover:before:w-[100%] before:top-[-10px]  before:left-[-10px]  relative before:w-[30px] before:h-[30px] before:bg-[#f90] before:absolute bg-white before:-z-10  before:rounded-tl-[10px]  after:content-[''] after:bottom-[-10px]  after:right-[-10px] after:w-[30px] hover:after:w-[100%] after:h-[30px] hover:after:h-[100%] after:bg-[#0e2033] after:absolute  after:rounded-br-[10px] after:-z-10 before:transition-all before:duration-1000 after:transition-all after:duration-1000 ">
        ...
        <div className="py-[90px] bg-[#0e2033]">
          <div className="container">
            <div className="grid grid-cols-2 gap-5 items-center">
              <div>
                <h2 className="text-white text-[50px] font-mono font-semibold leading-tight">Let<span className="text-[#f90]">'</span>s Turn Your Book
                  Into A Best Seller<span className="text-[#f90]">.</span></h2>
                ...
                <div className='flex gap-5 mt-5'>
                  <CTA text="lets Discusss" className=' capitalize bg-transparent text-[#f90] border-[#f90] border-2' />
                  <CTA text="(855) 500 0057" className='capitalize' />
                </div>
              </div>
              <div>
                <div className="bg-slate-50 py-4 px-8 border-[10px] border-t-[#f90] border-r-transparent border-b-transparent border-l-[#f90]">
